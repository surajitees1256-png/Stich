...
function Lv() {
  ...
  const gucciProducts = products.filter(
    (item) => item.brand?.toLowerCase() === "lv",
  );
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <h1 className="text-3xl font-bold text-center mb-6">Lv Collection</h1>

      {gucciProducts.length === 0 ? (
        <p className="text-center text-gray-500">No Lv Products Found</p>
      ) : (
